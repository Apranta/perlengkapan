	...
	<div class="main-content">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="<?= base_url('admin_unit/permintaan_barang') ?>">Permintaan Barang</a>
                        </li>
                        <li class="active">
		...
		<div class="panel-body white-bg">
            <div class="ibox">
                ...
                <a href="<?= base_url('admin_unit/permintaan_barang') ?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
            </div>
        </div>
	</div>
